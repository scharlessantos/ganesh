...
public class JSONPojoConvertorFactory implements JSON.Convertor
{
	 ...
	 * @param fromJSON If true, the class name of the objects is included in the generated JSON and is used to instantiate the object when JSON is parsed (otherwise a Map is used).
	 */
